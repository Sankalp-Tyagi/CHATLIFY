...
const UserSidebar = () => {
  ...
  return (
    <div className="max-w-[20em] w-full h-screen flex flex-col border-r border-r-white/10 text-center">
      <h1 className="bg-black mx-3 rounded-lg mt-3 px-2 py-1 text-[#71e7f0] text-xl font-semibold">
        CHATLIFY
      </h1>
